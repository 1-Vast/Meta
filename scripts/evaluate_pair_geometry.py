...
from scripts.pretrain_pair_geometry import (MechanismCorpus, PairGeometryPretrainer,
                                                 TrainConfig)
...
def evaluate_pair_geometry(records_path: str | Path, supervision_dir: str | Path,
    ...
    model = PairGeometryPretrainer(int(checkpoint["protein_dim"]), config).to(device)
