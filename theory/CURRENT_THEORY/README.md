...
This directory contains the complete current theory surface.

- `PURE_MATHEMATICAL_THEORY.md`: architecture-independent definitions and results.
- `QPSMP_COLD_TARGET_MODEL_THEORY.md`: model specialization, trainable meta-learning contract,
  generalization interface, and admission protocol.
