"""Stage Q2d-1e span-param DIAGNOSTIC gate adjudication (frozen gate).
...
def main():
    ladder = json.loads((HERE / "Q2D1E_SPANPARAM_LADDER.json").read_text(encoding="utf-8"))
    ...
    json.dump(out, open(HERE / "Q2D1E_SPANPARAM_GATE.json", "w"), indent=1)
